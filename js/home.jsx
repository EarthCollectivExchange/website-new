/* ============================================================
   EarthOS — Homepage (10 content blocks)
   ============================================================ */
function Home() {
  useRevealRoot();
  ...
  return (
    <div className="home-root">
        ...
        <div className="grid duo" style={{ gridTemplateColumns: "1.15fr 0.85fr", alignItems: "center", gap: "clamp(20px,4vw,60px)" }}>
          <div>
            <Reveal className="row wrap" style={{ gap: "0.8rem", marginBottom: "1.6rem" }}>
              ...
              <span className="mono dim" style={{ fontSize: "0.78rem" }}>Stage: pre-MVP · honesty over hype</span>
            </Reveal>
            <Reveal delay={80}>
            ...
            <Reveal delay={240} className="row wrap" style={{ gap: "0.9rem", marginTop: "2rem" }}>
              <a className="btn btn-primary" href="#/about">Enter EarthOS <span className="arrow">→</span></a>
        ...
        <div className="grid duo" style={{ gridTemplateColumns: "1fr 1fr", gap: "clamp(20px,4vw,56px)", alignItems: "center" }}>
          <div>
            ...
            <Reveal delay={80} style={{ marginTop: "1.4rem" }}>
              <a className="btn btn-ghost" href="#/messaging">Explore Messaging <span className="arrow">→</span></a>
            </Reveal>
          </div>
      ...
      <section className="container section">
        <Reveal className="card" style={{ padding: "clamp(1.6rem,4vw,3rem)", overflow: "hidden" }}>
          <div className="grid duo" style={{ gridTemplateColumns: "1.1fr 0.9fr", gap: "clamp(20px,4vw,48px)", alignItems: "center" }}>
            <div>
              <span className="eyebrow">QLPA Matrix · the source</span>
              ...
              <div style={{ marginTop: "1.4rem" }}><a className="btn btn-ghost" href="#/qlpa">Into the Matrix <span className="arrow">→</span></a></div>
            </div>
      ...
      <section className="container section">
        <div className="grid cols-2" style={{ alignItems: "center", gap: "clamp(20px,4vw,56px)" }}>
          <Reveal>
            ...
            <div style={{ marginTop: "1.4rem" }}><a className="btn btn-ghost" href="#/privacy">Privacy & Sovereignty <span className="arrow">→</span></a></div>
          </Reveal>
      ...
      <section className="container section">
        ...
        <Reveal style={{ marginTop: "1.6rem" }}><a className="btn btn-ghost" href="#/roadline">See the full Roadline <span className="arrow">→</span></a></Reveal>
      </section>
      ...
      <section className="container section">
        <Reveal className="card" style={{ padding: "clamp(1.6rem,4vw,2.8rem)" }}>
          <div className="row wrap" style={{ justifyContent: "space-between", gap: "1rem", alignItems: "flex-end", marginBottom: "1.6rem" }}>
            <div>
              <span className="eyebrow">Current status · honesty is a feature</span>
              <h2 className="h2" style={{ margin: "0.6rem 0 0" }}>Nothing here pretends to be finished.</h2>
            </div>
            <a className="btn btn-ghost" href="#/status">Full ledger <span className="arrow">→</span></a>
          </div>
          <div className="grid cols-3">
            {Object.entries(window.EARTHOS.STATUS).map(([k, v], i) => (
      ...
      {/* 10 — INVITATION TO COLLABORATORS */}
      <section className="container section">
        <Reveal className="card" style={{ padding: "clamp(2.5rem,6vw,5rem)", textAlign: "center" }}>
          <div>
            ...
            <div className="row wrap" style={{ justifyContent: "center", gap: "0.9rem" }}>
              <a className="btn btn-primary" href="#/contact">Offer to help <span className="arrow">→</span></a>
