# EarthOS Messaging — Foundation Architecture Map

## What This Is

EarthOS Messaging is a local-first, consent-first, QLPA-governed messaging system. This document describes the root architecture — the scaffolding that everything else builds on.
...
lib/
  ...
  messaging/       Active    Core messaging types, modes, preferences, persistence
...
components/
  ...
  messaging/       Active    57 messaging components
  ui/              Active    42 Radix UI primitives
...
6. Wire Stats events to actual messaging actions (message sent, etc.)
