/**
 * Trust Levels
 * Canonical definitions for the trust gradient used throughout EarthOS Messaging.
 * These extend the TrustLevel type defined in lib/messaging/types.ts with richer metadata.
 */
